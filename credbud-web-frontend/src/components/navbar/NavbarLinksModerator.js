// Chakra Imports
import {Avatar,Button, Flex, Icon, Image, Link, Menu, MenuButton, MenuItem, MenuList, Text, useColorModeValue, useColorMode, Center} from '@chakra-ui/react';
// Custom Components
...
export default function HeaderLinks(props) {
    const { getUserProfile, userProfile } = useUserAuth()
